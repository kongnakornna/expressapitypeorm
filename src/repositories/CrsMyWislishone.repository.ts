...
import { CrsMyWislishone } from "../entities/CrsMyWislishone.entity";
...
@EntityRepository(CrsMyWislishone)
export class CrsMyWislishoneRepository extends Repository<CrsMyWislishone>{
